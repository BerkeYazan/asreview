        ...
        <Stack spacing={3}>
          <Box>
            ...
            <Typography variant="body2" align="justify">
              AI models learn from your decisions and help you identify relevant
              records and accelerate your review process.
            </Typography>
          </Box>
              ...
              <Grid size={1}>
                ...
                >
                  <Stack spacing={1}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Makes predictions about relevance based on your decisions
                    </Typography>
                  </Stack>
                </Box>
              </Grid>
                      ...
                      <Alert severity="info" sx={{ mb: 3 }}>
                          ...
                          "Composing a custom AI model is an advanced feature recommended only for experienced users. "}
                        {
                          <>
                            ...
                            substantially longer to vectorize the dataset than
                            the faster <strong>Ultra</strong> models. While it
                            trains the model, you can continue screening with
                            the previous model. The system will automatically
                            switch to the new model as soon as it's ready.
                          </>
                        }
                      </Alert>
                    )}
                  <FormControl fullWidth>
                    ...
                    >
                      <ListSubheader sx={{ bgcolor: "transparent" }}>
                        Ultra - Fast, lightweight learner for performant
                        reviewing
                      </ListSubheader>
                      ...
                      <ListSubheader sx={{ bgcolor: "transparent" }}>
                        Custom - Built your own learner from available
                        components
                      </ListSubheader>
